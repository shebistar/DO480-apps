...
class MultiClusterACM(OpenShift):
    """Activity class."""
    __LAB__ = "multicluster-acm"
    ...
    def finish(self):
        items = [
            ...
            {
                "label": "Verifying that the RHACM klusterlet cluster roles are not present in the managed cluster. Deleting if present.",
                "task": self.run_playbook,
