...
class PolicyCompliance(OpenShift):
    ...
    def start(self):
        ...
        items = [
            ...
            },
            {
                ...
                "task": self.run_playbook,
                "playbook": "ansible/compreview-deploy/quay_images.yaml"

            },
            {
                "label": "Checking RHACS secured cluster policy deployed",
                "task": self.run_playbook,
                "playbook": "ansible/compreview-deploy/policy_check.yaml"

            },
            {
                "label": "Checking that RHACS secured cluster is installed on the hub cluster.",
                "task": self.run_playbook,
                "playbook": "ansible/compreview-deploy/rhacs_secure_hub_check.yaml"

            },
            {
                "label": "Checking that RHACS secured cluster is installed on the managed cluster.",
                "task": self.run_playbook,
                "playbook": "ansible/compreview-deploy/rhacs_secure_managed_check.yaml"

            },
            {
                "label": "Checking cluster init secrets in the hub cluster",
                "task": self.run_playbook,
                "playbook": "ansible/compreview-deploy/secret_check_hub.yaml"

            },
            {
                "label": "Checking cluster init secrets in the managed cluster",
                "task": self.run_playbook,
                "playbook": "ansible/compreview-deploy/secret_check_managed.yaml"

            },
            {
                "label": "Checking if secret 'compsecret' exists in the hub cluster",
                "task": self.run_playbook,
                "playbook": "ansible/compreview-deploy/compsecret_hub_check.yaml"

            },
            {
                "label": "Checking if secret 'compsecret' exists in the managed cluster",
                "task": self.run_playbook,
                "playbook": "ansible/compreview-deploy/compsecret_managed_check.yaml"

            },
            {
                "label": "Checking if application 'hello-app' exists",
            ...
            {
                "label": "Checking that observability service. Deleting if present. This command takes a while. Do not interrupt the execution.",
                "task": self.run_playbook,
    ...
    def finish(self):
        ...
        items = [
            ...
            {
                "label": "Removing the compreview-install namespace",
            ...
            {
                "label": "Removing the rhacs-install namespace",
                "task": self._delete_resource,
                "kind": "Project",
                "api": "project.openshift.io/v1",
                "name": "rhacs-install",
            ...
            },
            {
                ...
                "task": self.run_playbook,
                "playbook": "ansible/compreview-deploy/rhacs_hub_remove.yaml"
            ...
            },
            {
                ...
                "task": self.run_playbook,
                "playbook": "ansible/compreview-deploy/rhacs_managed_remove.yaml"
    ...
    def grade(self):
        ...
        items = [
            ...
            {
                "label": "Checking env label",
                "task": self.run_playbook,
                "playbook": "ansible/compreview-deploy/label_check.yaml"

            },
            {
                "label": "Checking `hello-app` deployment for the stage environment",
                "task": self.run_playbook,
                "playbook": "ansible/compreview-deploy/hub_image_check.yaml"

            },
            {
                "label": "Checking `hello-app` deployment for the production environment",
                "task": self.run_playbook,
                "playbook": "ansible/compreview-deploy/managed_image_check.yaml"
