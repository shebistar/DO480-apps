...
#
# NAME
#     applications-resources - DO480 Configure lab exercise script
#
# SYNOPSIS
#     applications-resources {start|finish}
#
...
applications-resources guided exercise.
"""
...
labname = 'applications-resources'
this_path = os.path.abspath(os.path.dirname(__file__))
_targets = ["localhost","workstation"]

class ApplicationsResources(OpenShift):
    """
    applications-resources lab script for DO480
    """
    __LAB__ = "applications-resources"
    ...
    def start(self):
        ...
        items = [
            ...
            steps.run_command(label="Project `mysql` is not present", hosts=["workstation"], command="oc", options="get projects mysql", returns="1", failmsg="The mysql project already exists, please delete it or run 'lab finish applications-resources' before starting this GE"),
