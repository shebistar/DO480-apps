...
#
# NAME
#     policy-governance - DO480 Configure lab exercise script
#
# SYNOPSIS
#     policy-governance {start|finish}
#
#        start   - prepare the system for starting the lab
#        finish  - perform post-exercise cleanup steps
#
# CHANGELOG
#   * Wed 24 Nov 2021 Harpal Singh <harpasin@redhat.com>
#   - original code

"""
Lab script for DO480 Configure.
This module implements the start and finish functions for the
policy-governance guided exercise.
"""
...
labname = 'policy-governance'
this_path = os.path.abspath(os.path.dirname(__file__))
_targets = ["localhost","workstation"]

class PolicyCompliance(OpenShift):
    """
    policy-governance lab script for DO480
    """
    __LAB__ = "policy-governance"
    ...
    def start(self):
        ...
        items = [
            ...
            {
                "label": "Project 'policy-governance' is not present",
            ...
            steps.run_command(label="Connecting to OCP4 managed cluster", hosts=["workstation"], command="oc login", options="-u admin -p redhat " + OCP4_MNG_API, returns="0"),
            steps.run_command(label="Update Certificate", hosts=["workstation"], command=this_path + "/files/policy-governance/update_certificate.sh", options="", returns="0"),
    ...
    def finish(self):
        ...
        items = [
            ...
            {
                "label": "Removing the policy-governance namespace",
            ...
            steps.run_command(label="Connecting to OCP4 managed cluster", hosts=["workstation"], command="oc login", options="-u admin -p redhat " + OCP4_MNG_API, returns="0"),
            steps.run_command(label="Revert Certificate", hosts=["workstation"], command=this_path + "/files/policy-governance/revert_certificate.sh", options="", returns="0"),
            {
