...
#
# NAME
#     operate-integrate - DO480 Configure lab exercise script
#
# SYNOPSIS
#     operate-integrate {start|finish}
#
#        start   - prepare the system for starting the lab
#        finish  - perform post-exercise cleanup steps
#
# CHANGELOG
#   * Thu 12 May 2022 Harpal Singh <harpasin@redhat.com>
#   - original code

"""
Lab script for DO480 Configure.
This module implements the start and finish functions for the
operate-integrate guided exercise.
"""
...
labname = 'operate-integrate'
this_path = os.path.abspath(os.path.dirname(__file__))
_targets = ["localhost","workstation"]

class PolicyCompliance(OpenShift):
    """
    operate-integrate lab script for DO480
    """
    __LAB__ = "operate-integrate"
    ...
    def finish(self):
        ...
        items = [
            ...
            {
                "label": "Removing the operate-integrate namespace",
                "task": self._delete_resource,
                "kind": "Project",
                "api": "project.openshift.io/v1",
                "name": "operate-integrate",
                "namespace": None,
            },
            {
