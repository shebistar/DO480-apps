...
#
# NAME
#     rhacs-import - DO480 Configure lab exercise script
#
# SYNOPSIS
#     rhacs-import {start|finish}
#
#        start   - prepare the system for starting the lab
#        finish  - perform post-exercise cleanup steps
#
# CHANGELOG
#   * Wed 27 Apr 2022 Harpal Singh <harpasin@redhat.com>
#   - original code
    ...
    def start(self):
        ...
        items = [
            ...
            },
            {
                ...
                "task": self.run_playbook,
                "playbook": "ansible/rhacs-import/policy_check.yaml",
                "fatal": True
            },
            {
                "label": "Checking that RHACS is installed on the hub cluster. This command takes a while. Do not interrupt the execution.",
                "task": self.run_playbook,
                "playbook": "ansible/rhacs-import/rhacs_check.yaml",
                "fatal": True
            },
            {
                "label": "Checking that RHACS SecuredCluster is available on the hub cluster. Deleting if present.",
                "task": self.run_playbook,
                "playbook": "ansible/rhacs-import/rhacs_hub_secure_remove.yaml"
