...
#
# NAME
#     rhacs-install - DO480 Configure lab exercise script
#
# SYNOPSIS
#     rhacs-install {start|finish}
#
#        start   - prepare the system for starting the lab
#        finish  - perform post-exercise cleanup steps
#
# CHANGELOG
#   * Tue 19 Apr 2022 Harpal Singh <harpasin@redhat.com>
#   - original code

"""
Lab script for DO480 Configure.
This module implements the start and finish functions for the
rhacs-install guided exercise.
"""
...
labname = 'rhacs-install'
this_path = os.path.abspath(os.path.dirname(__file__))
_targets = ["localhost", "workstation"]

class PolicyCompliance(OpenShift):
    """
    rhacs-install lab script for DO480
    """
    __LAB__ = "rhacs-install"
    ...
    def start(self):
        ...
        items = [
            ...
            {
                "label": "Project 'rhacs-install' is not present. Deleting if present.",
                "task": self.run_playbook,
                "playbook": "ansible/rhacs-install/policy_namespace.yaml"

            },
            {
                "label": "Checking that RHACS is installed. Deleting if present. This command takes a while. Do not interrupt the execution.",
                "task": self.run_playbook,
                "playbook": "ansible/rhacs-install/rhacs_remove.yaml"

            },
            {
                "label": "Configuring Rsyslog server",
                "task": self.run_playbook,
                "playbook": "ansible/rhacs-install/rsyslog_server_config.yaml"
