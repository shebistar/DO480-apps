...
#
# NAME
#     operate-management - DO480 Configure lab exercise script
#
# SYNOPSIS
#     operate-management {start|finish}
#
#        start   - prepare the system for starting the lab
#        finish  - perform post-exercise cleanup steps
#
# CHANGELOG
#   * Wed 18 May 2022 Harpal Singh <harpasin@redhat.com>
#   - original code

"""
Lab script for DO480 Configure.
This module implements the start and finish functions for the
operate-management guided exercise.
"""
...
labname = 'operate-management'
this_path = os.path.abspath(os.path.dirname(__file__))
_targets = ["localhost","workstation"]

class PolicyCompliance(OpenShift):
    """
    operate-management lab script for DO480
    """
    __LAB__ = "operate-management"
    ...
    def start(self):
        ...
        items = [
            ...
            {
                "label": "Checking RHACS policies deployed in the previous exercise",
                "task": self.run_playbook,
                "playbook": "ansible/operate-integrate/policy_check.yaml"

            },
            {
                "label": "Checking that RHACS is installed on the hub cluster.",
                "task": self.run_playbook,
                "playbook": "ansible/operate-integrate/rhacs_hub_check.yaml"

            },
            {
                "label": "Checking that RHACS is installed on the managed cluster.",
                "task": self.run_playbook,
                "playbook": "ansible/operate-integrate/rhacs_managed_check.yaml"
            ...
            steps.run_command(label="Project `etherpad` is not present in the local-cluster", hosts=["workstation"], command="oc", options="get projects etherpad", returns="1", failmsg="The etherpad Project already exists, please delete it or run 'lab finish operate-vulnerability' before starting this GE"),
    ...
    def finish(self):
        ...
        items = [
            ...
            {
                "label": "Removing the etherpad namespace",
            ...
            {
                "label": "Removing the RHACS on hub cluster. This command takes a while. Do not interrupt the execution.",
                "task": self.run_playbook,
                "playbook": "ansible/rhacs-import/rhacs_hub_remove.yaml"

            },
            {
                "label": "Removing the RHACS on hub cluster. This command takes a while. Do not interrupt the execution.",
                "task": self.run_playbook,
                "playbook": "ansible/rhacs-import/rhacs_managed_remove.yaml"
